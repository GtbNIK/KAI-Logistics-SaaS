...
const Sidebar = ({ isOpen, toggleSidebar }) => {
    ...
    const menuGroups = [
        ...
        },
        {
            ...
            label: 'Operaciones',
            items: [
                { to: '/dashboard/cotizaciones', icon: FileText, label: 'Cotizaciones', roles: ['ADMIN', 'SALES'] },
                ...
                { to: '/dashboard/aviso-cobro', icon: Receipt, label: 'Aviso de Cobro', roles: ['ADMIN'] },
            ]
        },
        {
            id: 'finanzas',
    ...
    return (
        ...
        >
            ...
            {/* Navigation Groups */}
            <div className="flex-1 overflow-y-auto py-6 px-3 space-y-6 scrollbar-thin scrollbar-thumb-white/20 scrollbar-track-transparent">
