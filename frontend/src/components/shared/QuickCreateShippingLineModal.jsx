...
const QuickCreateShippingLineModal = ({ isOpen, onClose, onSuccess }) => {
    ...
    const handleSubmit = async (e) => {
        ...
        setLoading(true);
        try {
            const result = await shipmentService.createShippingLine(name.trim(), code.trim() || undefined);
                ...
                <form onSubmit={handleSubmit} className="p-6 space-y-4">
                    ...
                    <div className="space-y-1">
                        ...
                        <input
                            ...
                            placeholder="Ej: MSC, CMA, HMM (opcional)"
                        />
                    </div>

                    <div className="space-y-1">
                        <label className="text-xs font-bold text-slate-400 uppercase ml-1">Nombre de la Naviera *</label>
                        <input
                            required
                            type="text"
                            autoFocus
