...
const QuickCreateShippingLineModal = ({ isOpen, onClose, onSuccess }) => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const result = await allyService.createAlly(data);
            showSuccess('¡Éxito!', 'Línea naviera creada correctamente');
            ...
            <div className="bg-white rounded-2xl shadow-2xl w-full max-w-sm overflow-hidden animate-in fade-in zoom-in-95 duration-200">
                ...
                <form onSubmit={handleSubmit} className="p-6 space-y-4">
                    ...
                    <div className="space-y-1">
                        <label className="text-xs font-bold text-slate-400 uppercase ml-1">Código Interno</label>
                        <input
                            type="text"
                            value={internalCode}
                        ...
                        />
                        <p className="text-xs text-slate-400 ml-1 mt-1">Si no se especifica, se generará automáticamente</p>
                    </div>

                    <div className="space-y-1">
                        <label className="text-xs font-bold text-slate-400 uppercase ml-1">Nombre de la Línea *</label>
                        <input
                            required
                            type="text"
                            autoFocus
...
export default QuickCreateShippingLineModal;
